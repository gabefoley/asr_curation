...
def test_validate_ids_main_from_command_line():
    ...
    os.system(f"python ./scripts/validate_ids.py --input_file ./test/files/test_original.csv --output_file {outpath}")
...
def test_validate_ids_call_command_line_directly():
    ...
    result = runner.invoke(vi.all_ids_lookup_cmd, ["--input_file", "test/files/test_original.csv", "--output_file", outpath])
...
def test_creating_and_validating_diverse_headers():
    ...
    seq_outpath = "test/files/output_test_diverse_5.csv"
