...
#
#     assert(os.path.exists("test/files/test_workflow/example_workflow/datasets/test_ec_1_1_1_86/subsets/all_kari/grasp_results/GRASP_ancestors.fa"))
#     assert(os.path.exists("test/files/test_workflow/example_workflow/datasets/test_ec_1_1_1_86/subsets/eukaryotic_test/grasp_results/GRASP_ancestors.fa"))
#
#
...
#         "test/files/test_workflow/keep_annotations/datasets/test_ec_1_1_1_86/subsets/all_kari/grasp_results/GRASP_ancestors.fa"))
#     assert (os.path.exists(
#         "test/files/test_workflow/keep_annotations/datasets/test_ec_1_1_1_86/subsets/eukaryotic_test/grasp_results/GRASP_ancestors.fa"))
#
